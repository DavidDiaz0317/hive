...
```powershell
& ([scriptblock]::Create((Invoke-RestMethod "https://raw.githubusercontent.com/DavidDiaz0317/hive/v0.3.1-integrated.4/v2/install-integrated.ps1")))
```
...
curl --fail --silent --show-error --location \
  https://raw.githubusercontent.com/DavidDiaz0317/hive/v0.3.1-integrated.4/v2/install-integrated.sh | sh
```
